...
export const StoryHeader = ({ stories }: StoryHeaderProps) => {
  ...
  return (
    <div className="w-full overflow-x-auto hide-scrollbar bg-card/95 backdrop-blur-lg border-b border-border shadow-lg">
      <div className="flex gap-3 p-4 min-w-max">
        ...
        {stories.map((story) => (
          ...
          >
            ...
            {/* User Avatar */}
            <div className={`absolute top-2 left-2 w-10 h-10 rounded-full flex items-center justify-center text-xl font-bold ${
              story.viewed ? 'bg-muted ring-2 ring-border' : 'bg-gradient-to-br from-primary via-accent to-primary ring-3 ring-primary'
            }`}>
